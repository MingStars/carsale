                  ...
                  $.ajax({
                      ...
                      success: function(json){
                    	 ...
                    	 /* for(var p in json){
                     	 ...
                     	 var nameList = ['汽车id', '品牌', '车名', '车型', '车龄(年)', '急于出售', '价格(万元)', '状态', '卖家id','操作'] //table的列名
                     	 var widthList = [100, 100, 100, 200, 100, 100, 100, 100, 100,100] //table每列的宽度
                     	 console.log(json);
                     	 var json = json;
                     	 /**
                     	...
                     	window.nicePage=
                     	        {table:"div",bar:"bar",limit:"10",color:"#1E9FFF",layout:["count","prev","page","next","limit","skip"],
                     			setCfg:function(b){nicePage.table=b.table;
                     			nicePage.bar=b.bar;
