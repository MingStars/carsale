...
function dogetUserByPhone (){
	var uId= $("#uId").val();
	var userName= $("#userName").val();
	var uPhone = $("#uPhone").val();
	var data = {uId: uId,userName: userName,uPhone: uPhone};
	//$("#table").empty(); 
	...
	console.log(data);
                  $.ajax({
                      ...
                      success: function(json){
                     	 ...
                     	 var nameList = ['用户编号', '用户账号', '用户姓名','手机号码', '用户注册日期', '最近登陆时间', '交易记录','操作','最近活动时间'] //table的列名
                     	 var widthList = [100, 100, 100, 100, 100,100, 100, 100, 200] //table每列的宽度
                     	 var json = json;
                     	 /**
