...
function doGetOrderById (){
	var carId= $("#carId").val();
	var sellerId= $("#sellerId").val();
	var buyerId = $("#buyerId").val();
	var orderStatus = $("#orderStatus").val();
	var data = {carId: carId,sellerId: sellerId,buyerId: buyerId,orderStatus: orderStatus};
	//$("#table").empty(); 
	...
	console.log(data);
                  $.ajax({
                      ...
                      success: function(json){
                     	 ...
                     	 var nameList = ['所有订单编号', '汽车id', '卖家id', '买家id', '订单状态', '操作'] //table的列名
