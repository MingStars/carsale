...
<img src="${li.uPhoto}" alt="Avatar" width="60" height="60"
               ...
               <li style="background:gray;">
                  ...
                  <ul class="nav collapse ">
                     ...
                     <li>
                     <li style="background:gray;">
                        <a href="${pageContext.request.contextPath}/SellerDepend" style="color:white; box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
               ...
               <li>
                  <a href="${pageContext.request.contextPath}/login/Collection" title="Standard" >
                     <em class="fa fa-table"></em>
                     <span class="item-text">收藏夹</span>                  </a>
               </li>
               <li>
                  <a href="${pageContext.request.contextPath}/home" title="Pages" data-toggle="" class="no-submenu">
            ...
            <div class="panel panel-default">
               ...
               <div class="table-responsive">
				...
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/PreSellerDepend?orderId=${uf.orderId}">确认</a></td>
				</tr>
			</c:forEach>
                     </tbody>
                  </table>
