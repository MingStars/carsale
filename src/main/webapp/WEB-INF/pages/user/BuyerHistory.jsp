	...
	<img src="${li.uPhoto}" alt="Avatar" width="60" height="60"
               ...
               <li style="background:gray;">
                  ...
                  <ul class="nav collapse ">
                     ...
                     <li style="background:gray;">
                        <a href="${pageContext.request.contextPath}/BuyerHistory" style="color:white; box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
            ...
            <div class="panel panel-default">
               ...
               <div class="table-responsive">
                  <table id="table-id" class="table table-bordered table-hover">
                     ...
                     <c:forEach items="${bu }" var="uf">
                        <tr>
                           <td>${uf.carInfo.carId}</td>
                           <td>${uf.carInfo.confName}</td>
                           <td>${uf.carInfo.price}</td>
                           <td>${uf.carInfo.carAge}</td>
                           <td>${uf.user.uId}</td>
                           <td>${uf.user.uPhone}</td>
                           <td><a href="${pageContext.request.contextPath}/PreBuyerHistoryUpdate?carId=${uf.carInfo.carId}">修改</a></td>
                        </tr>
                     </c:forEach>
                     </tbody>
                  </table>
