...
<div class="shoubu"style="text-align:center;font-size:30px;">
	<div class="shoubu_p">
	<img alt="" src="images/dongtong2.png"style="width:130px;position:relative;left:-100px;">
	
	<p class="logo" style="font:700 1.5em Raleway,Arial,Helvetica;position:relative;left:-60px;top:0px;">东 通 二 手 车</p>
	<table class="backtable"style="font-weight: 600;">
		<tr>
			<td>
				<p><a href="${pageContext.request.contextPath}/login/home">首页</a></p>
				<p><a href="${pageContext.request.contextPath}/carHome" >我要买车</a></p>
				<p><a  href="javascript:showDialog();">我要卖车</a></p>
				<p> <a href="${pageContext.request.contextPath}/Welcome?userid=${user}" >个人中心</a></p>
    ...
    <div class="ui-dialog-content">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/showCar2" id="baseinfo" class="form-horizontal">
                    <!-- <fieldset>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                             <input type="text" style="width: 260px; margin-left:20px;" id="brand" value="" placeholder="如：奔驰、宝马......"
                                       class="form-control">
                                       </div>
                                        <label class="col-sm-2 control-label">    </label>
                              <div class="col-sm-10">
                             <input type="text" style="width: 260px; margin-left:20px;"  placeholder="请输入车型" id="carName" value=""
                                       class="form-control">
                                       </div>
                      <!--       <div class="col-sm-10">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" style="width: 260px; margin-left:20px;" name="carMileage" id="carMileage" name="carMileage" value=""  placeholder="单位（万公里）"
                                       class="form-control">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input style="width: 260px; margin-left:20px;" id="price" name="price" value="" placeholder="单位（万元）"
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input style="width: 260px; margin-left:20px;" id="carAge" name="carAge" value="" placeholder="单位（年）"
                                       type="text" class="form-control">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="last-child">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select style="width: 260px; margin-left:20px;" id="carDamage" name="carDamage" value="" class="form-control m-b">
                                    <option>0%</option>
                                    <option>5%</option>
                                    <option>10%</option>
                                    <option>15%</option>
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="address" value="" id="address" style="width: 260px; margin-left:20px;" placeholder="请填写详细地址"
                                       type="text" class="form-control">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="licenseAddress" id="licenseAddress" value="" style="width: 260px; margin-left:20px;" placeholder="如：陕西乾县"
                                       type="text" class="form-control">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input name="islocked" id="iseager" value="" style="width: 260px; margin-left:20px;" placeholder="是否急于出售：是/否"
                                       type="text" class="form-control">
                                <br>
                            </div>
                        </div>
...
<script type="text/javascript">
    $("#carinfo_submit").click(function () {
        ...
        var carMileage = $.trim($("#carMileage").val());
        var price = $.trim($("#price").val());
        var carAge = $.trim($("#carAge").val());
        var carDamage = $.trim($("#carDamage").val());
        var address = $.trim($("#address").val());
        var licenseAddress = $.trim($("#licenseAddress").val());
        var iseager = $.trim($("#iseager").val());
        var islocked = '可出售';
        var carInfo = {carId: id,brand: brand,carName: carName,carMileage: carMileage,
        	price: price,carAge: carAge,carDamage: carDamage,address: address,licenseAddress: licenseAddress,isEager: iseager,isLocked: islocked};
        console.log(carInfo);
        /* if (fileInput == "") {
            alert("请至少上传一张图片！");
            return false;
