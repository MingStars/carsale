...
<section class="wrapper">
               ...
               <li >
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/carManager/bookedCar" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
    ...
    <section>
        ...
        <section class="main-content">
            <h3>已预约汽车信息
                <br>
                <small>可管理已预约汽车信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">已预约汽车
...
<script  src="ajax/bookedCarAjax.js" type="text/javascript"></script> 
<!-- Plugins-->
