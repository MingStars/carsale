...
<section class="wrapper">
               ...
               <li >
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/carManager/salableCar" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
    ...
    <section>
        ...
        <section class="main-content">
            <h3>可出售汽车管理
                <br>
                <small>管理可出售的汽车信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">可出售汽车
...
<script  src="ajax/saleableCarAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
