...
<section class="wrapper">
        ...
        <nav class="sidebar">
            <ul class="nav">
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/carManager/auditeCar" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
    ...
    <section>
        ...
        <section class="main-content">
            <h3>汽车审核管理
                <br>
                <small>可管理待审核汽车信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">待审核汽车
...
<script  src="ajax/auditeCarAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
