...
<section class="wrapper">
    ...
    <section>
        ...
        <section class="main-content">
            <h3>所有汽车信息
                <br>
                <small>可管理所有汽车信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">所有汽车信息
              ...
              <script src="js/jquery-1.11.2.min.js"></script>
                    ...
                    <input type="button" onclick="getCarById()" value="  查 询   "/>
                    </div>
         	...
         	$(document).ready(function(){
                  ...
                  $.ajax({
                      ...
                      success: function(json){
                     	 ...
                     	 var nameList = ['汽车id', '品牌', '车名', '年龄', '车型', '价格(万元)', '急于出售', '状态', '卖家id'] //table的列名
                     	 var widthList = [100, 100, 100, 100, 100, 100, 100, 100, 100] //table每列的宽度
                     	 var json = json;
                     	 /**
