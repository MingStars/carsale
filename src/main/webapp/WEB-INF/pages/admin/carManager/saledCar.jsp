            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/carManager/saledCar" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
...
<script  src="ajax/saledCarAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
