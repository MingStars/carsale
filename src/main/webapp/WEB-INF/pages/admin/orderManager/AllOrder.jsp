...
<section class="wrapper">
               ...
               <li >
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/orderManager/AllOrder" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
                                <span class="item-text">所有</span>                  </a>
                        </li>
                    </ul>
                </li>
    ...
    <section>
        ...
        <section class="main-content">
            <h3>所有订单
                <br>
                <small>可管理所有的订单信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">所有订单
                ...
                <div>
                                                         ...
                                                         汽车Id&nbsp;<input type="text"  id="carId" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         卖家Id&nbsp;<input type="text"  id="sellerId">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         买家Id&nbsp;<input type="text"  id="buyerId">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                        
                    ...
                    <input type="button" onclick="doGetOrderById()" value="  查 询   "/>
                    </div>
...
<script  src="ajax/AllOrderAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
