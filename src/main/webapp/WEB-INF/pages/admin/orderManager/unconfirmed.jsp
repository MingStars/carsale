...
<section class="wrapper">
               ...
               <li >
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/orderManager/unconfirmed" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
    ...
    <section>
        ...
        <section class="main-content">
            <h3>未确认订单
                <br>
                <small>可管理未确认的订单信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">未确认订单
...
<script  src="ajax/unconfirmedAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
