...
<section class="wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <ul class="nav collapse ">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/orderManager/confirmed" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
    ...
    <section>
        ...
        <section class="main-content">
            <h3>已确认订单
                <br>
                <small>可管理已确认的订单信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">已确认订单
...
<script  src="ajax/confirmedAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
