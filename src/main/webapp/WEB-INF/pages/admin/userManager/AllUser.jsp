        ...
        <nav class="sidebar">
            <ul class="nav">
                ...
                <li >
                    ...
                    <ul class="nav collapse ">
                        <li>
                            <a href="${pageContext.request.contextPath}/doGetURL?page=admin/userManager/AllUser" style="box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
                ...
                <div class="panel-heading">用户信息
                    ...
                    <a href="#" data-perform="panel-collapse" data-toggle="tooltip" title="Collapse Panel" class="pull-right">
                      ...
                      <div>
                                                         ...
                                                         用户编号&nbsp;<input type="text"  id="uId" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        用户账号&nbsp;<input type="text"  id="userName">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                         手机号码&nbsp;<input type="text"  id="uPhone">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                                        
                    <!-- 激活状态&nbsp;&nbsp;<select id="orderStatus">
                    <option value="">请选择</option>                                        
                    <option value=0>被取消</option>
                    <option value=1>未确认</option>
                    </select>&nbsp;&nbsp;&nbsp;&nbsp; -->
                    <input type="button" onclick="dogetUserByPhone()" value="  查 询   "/>
                    </div>
                    ...
                    <table id="table-id" class="table table-bordered table-hover">
                        ...
                        <c:forEach items="${itemsList}" var="item">
                            <tr>
                                ...
                                <td>${item.userName}</td>
                                <td>${item.uName}</td>
                                <td>${item.uRegisterTime}</td>
                                <td>${item.uLoadTime}</td>
                                <td><a href="dogetTranById?uId=${item.userName}">查看</a></td>
                                <td><a href="#">删除</a>&nbsp;&nbsp;<a href="#">提醒</a></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
...
<script  src="ajax/AllUserAjax.js" type="text/javascript"></script>  
<!-- Plugins-->
