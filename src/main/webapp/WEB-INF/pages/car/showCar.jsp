        ...
        <section class="main-content">
            ...
            <!-- START panel-->
             ...
             <div class="detailcontent">
                <form action="../showCar2" method="post"><!-- 跳转controller页面 -->
                <input name="car_id" value=1 type="hidden"/>
           	<div id="jiben"> 
                  ...
                  <tr>
                    ...
                    <table class="table1" id="altrowstable">
                     ...
                     <input style="position:relative;left:600px;top:1200px;width:80px;height:30px " type="submit"  value="确定">
                     <input style="position:relative;left:600px;top:1200px;width:80px;height:30px " type="button" href="home" value="取消" >
                     </form>
                </div>
