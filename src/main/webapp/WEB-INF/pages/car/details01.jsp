...
<!--     <link href="css/style.css" rel="stylesheet" type="text/css" media="all"/> -->
    <!-- 加载js/css-->
<%--     <script type="text/javascript" src="${pageContext.request.contextPath }/js/dateils.js"></script>  --%>
   <script type="text/javascript" src="${pageContext.request.contextPath }/js/dateils2.js"></script>
    <!-- start details -->
...
<div class="shoubu"style="text-align:center;font-size:30px;">
	<div class="shoubu_p">
	<img alt="" src="images/dongtong2.png"style="width:120px;position:relative;left:-300px;top: 20px;">
	...
	<table class="backtable"style="font-weight: 600;">
		<tr>
			<td>
				...
				<p><a href="${pageContext.request.contextPath}/login/home" >我要卖车</a></p>
            ...
            <div class="single">
                ...
                <div class="infor-main service-open">
                    <div class="product-detail" id="page-slide" data-group-count="4">
                       ...
                       <div>
                            <img alt="111" src="${carInfo.picUrl}" style="width: 700px;height: 450px;">
                        </div>  
                    ...
                    <div class="product-textbox">
                        <div class="titlebox">
                            <p>${carInfo.brand }  ${carInfo.carName }  ${carInfo.confName }</p>
                            <span class="labels">4s保养</span>
                        </div>

                        <ul class="assort clearfix">
                            <li class="one"><span>${carInfo.carAge }</span>车齡</li>
                            <li class="two"><span>${carInfo.carMileage }</span>表显里程</li>
                            <li class="three"><span>${carInfo.licenseAddress }</span>上牌地</li>
                            <li class="four"><span>${carInfo.carDamage}</span>车损状况</li>
                            <li class="last"><span>${carInfo.gearBox}</span>变速箱</li>
                        </ul>

                        <div class="pricebox js-disprice">
                            <i class="ico-type">车主报价：</i>
                            <span class="pricestype">${carInfo.price}  <span class="f14">万</span></span>
                        </div>
...
<div class="footer_bg1">
    ...
    <script type="text/javascript">
         ...
         <!--    <a href="#" id="toTop" style="display: block;"><span id="toTopHover" style="opacity: 1;"></span></a>
            ...
            <td>
            <div class="copy">
                <p class="link">SouthWestJiaoTongUniversity 2019.兆隆公司(技术部)-第一小组.</p>
            </div>
            </td>
            <div class="clear"></div>
        </div>
